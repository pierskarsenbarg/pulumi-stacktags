...
namespace Pulumi.stacktags
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.stacktags.version.txt");
    ...
    internal sealed class stacktagsResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public stacktagsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
